...
#servidor de teste
    //$_form[] = '<form target="pagseguro" action="https://pagseguro.uol.com.br" method="post">';
    }
    ...
    $return = implode("\n", $_form);
    //alteracao deste campo para nao exibir o botao com duplicidade no ambiente do drupal    
